...
import '../../../data/repositories/upcoming_movies/upcoming_movies_repo.dart'
    as _i18;
import '../../repositories/actor_profile/i_actor_profile_repo.dart' as _i15;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i13.IMoviesResultGridRepo>(
      () => _i14.MoviesResultGridRepository());
  gh.lazySingleton<_i15.IPersonDetailsRepo>(
      () => _i16.PersonDetailsRepository());
  gh.lazySingleton<_i17.IUpcomingMoviesRepo>(
      () => _i18.UpcomingMoviesRepository());
  gh.factory<_i19.ImageSliderBloc>(
      () => _i19.ImageSliderBloc(get<_i5.IImageSliderRepo>()));
  gh.factory<_i20.LoginPosterBloc>(
      () => _i20.LoginPosterBloc(get<_i7.ILoginImagesRepo>()));
  gh.factory<_i21.MovieDetailsBloc>(
      () => _i21.MovieDetailsBloc(get<_i9.IMovieDetailsRepo>()));
  gh.factory<_i22.MoviesResultGridBloc>(
      () => _i22.MoviesResultGridBloc(get<_i13.IMoviesResultGridRepo>()));
  gh.factory<_i23.PersonDetailsBloc>(() => _i23.PersonDetailsBloc(
      get<_i15.IPersonDetailsRepo>(), get<_i11.IMovieListRepo>()));
  gh.factory<_i24.UpcomingMoviesBloc>(
      () => _i24.UpcomingMoviesBloc(get<_i17.IUpcomingMoviesRepo>()));
  gh.factory<_i25.DiscoverBloc>(
      () => _i25.DiscoverBloc(get<_i3.IDiscoverRepo>()));
  return get;
}

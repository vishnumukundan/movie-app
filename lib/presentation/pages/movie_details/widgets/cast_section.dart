...
//             final dataList = state.movieDetailsData.cast;
...
//                   if (dataList[index].cast[index].knownForDepartment ==
//                       'Acting') {
//                     if (state.isLoading) {
//                       return CastSectionSkelton__widget();
//                     } else {
//                       return PersonImageAndNameCard__widget(
//                         image: dataList[index].cast[index].profilePath,
//                         name: dataList[index].cast[index].name,
//                         isLoading: state.isLoading,
//                         onTap: () => PageNav.push(
//                           context,
//                           ActorProfilePage(
//                               personId: dataList[index].cast[index].id),
//                         ),
//                       );
//                     }
//                   }
